        ...
        return (
            <div>
                <section className="hero hero-home is-fullheight  is-bold" id="home">
                    ...
                    {ImgSec('../../product-bg/fodder.png', 'Continuous Grow The Plays An Important Role In Developing And Safe Guarding The Company For The Long Term.')}
