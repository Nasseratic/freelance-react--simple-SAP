...
<table className="table is-bordered">
    ...
    <tr>
       ...
       <lu> The price of yellow corn in bulk can be found in our price list </lu>
...
<table className="table is-bordered">
    ...
    <p>
      <lu>  The price of sunflower meal in bulk can be found in our prices list .
...
contents['De-Ice'] = (
<body>
    <img src={remImg} style={ { maxHeight : 300, float: 'right' } }/>
  ...
  <li>  Origin: Egypt</li>
 <li>   Delivery terms: EXW , FOB , CIF OR EVEN DDP to the warehouse of our client , incomers 2010</li>
